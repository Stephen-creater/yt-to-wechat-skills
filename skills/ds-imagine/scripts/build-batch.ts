...
Options:
  ...
  --provider <name>    Provider for ds-imagine batch tasks (default: replicate)
  --model <id>         Explicit model for ds-imagine batch tasks (default: resolved by ds-imagine config/env)
